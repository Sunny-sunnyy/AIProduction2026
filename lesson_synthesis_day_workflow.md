...
- File code nếu có: `.ipynb`, `.py`, `.md` project folder, Docker/config, hoặc các file liên quan.
- File slide nếu có.
...
Thông tin cố định:
- course_domain: AI Engineer Production Track: Deploy LLMs & Agents at Scale
- course_name: AI Engineer Production Track: Deploy LLMs & Agents at Scale

Quy tắc làm việc:
1. Đọc file workflow `lesson_synthesis_day_workflow.md` G:\AIProduction_t6_2026\production\lesson_synthesis_day_workflow.md trước.
